...
MODEL_TYPE=llama torchrun --nproc-per-node=8 cache_logprobs.py --model_dir model_dir/llama-2-70b ---params_file params.json --global_batch_size=4 --micro_batch_size=4
