#!/bin/bash
set -e
MODEL_TYPE=nanopar torchrun --nproc-per-node=2 check_activations.py --model_dir model_dir/llama-2-7b ---params_file params.json --tensor_model_parallel_size=2 --te_params=0 --te_forward=1
